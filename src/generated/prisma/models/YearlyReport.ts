...
// @ts-nocheck 
/*
 * This file exports the `YearlyReport` model and its related types.
 *
...
export type GetYearlyReportAggregateType<T extends YearlyReportAggregateArgs> = {
      [P in keyof T & keyof AggregateYearlyReport]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateYearlyReport[P]>
    : Prisma.GetScalarType<T[P], AggregateYearlyReport[P]>
}
...
export type GetYearlyReportGroupByPayload<T extends YearlyReportGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<YearlyReportGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof YearlyReportGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], YearlyReportGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], YearlyReportGroupByOutputType[P]>
      }
    >
  >
...
export type YearlyReportCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<YearlyReportFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface YearlyReportDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['YearlyReport'], meta: { name: 'YearlyReport' } }
  /**
   ...
   * })
  **/
  count<T extends YearlyReportCountArgs>(
    args?: Prisma.Subset<T, YearlyReportCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], YearlyReportCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends YearlyReportGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, YearlyReportGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetYearlyReportGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
