 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
     ...
     * `prisma.taskOccurrence`: Exposes CRUD operations for the **TaskOccurrence** model.
      ...
      * ```
      */
    get taskOccurrence(): Prisma.TaskOccurrenceDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
    ...
    /**
     * `prisma.yearlyReport`: Exposes CRUD operations for the **YearlyReport** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more YearlyReports
      * const yearlyReports = await prisma.yearlyReport.findMany()
      * ```
      */
    get yearlyReport(): Prisma.YearlyReportDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
